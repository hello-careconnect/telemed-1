...
const testimonials = [
  ...
  {
    quote: 'I trust a doctor more when I can read what other patients actually said. Not just a star number — the full review.',
    name: 'Tanvir R.',
      ...
      <div className="container max-w-[1440px] mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="mt-6 font-heading font-bold text-[32px] sm:text-[40px] text-text-primary leading-[1.15]">
            Patients who{' '}
            <span className="font-display italic text-primary">shaped</span>{' '}
            this platform.
          </h2>
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="font-body text-[17px] text-text-body italic leading-[1.7] mb-6">
                  "{t.quote}"
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-body text-[13px] text-text-muted">{t.meta}</p>
                  </div>
                </div>
              </div>
            </motion.div>
