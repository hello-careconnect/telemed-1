...
import {
  Search, CheckCircle, BadgeCheck,
  Building2, Clock, Pill, Plus, Send, TrendingUp, Bell, Stethoscope,
  Banknote, GraduationCap, Camera, Languages, ChevronRight, Star,
} from 'lucide-react';
  ...
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
    <div style={{ background: '#0A9E8A', padding: '0 16px 14px', flexShrink: 0 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 14, color: 'white', margin: 0 }}>My Profile</p>
      </div>
    </div>
      ...
      <div style={{ background: 'hsl(var(--background))', border: '1px solid hsl(var(--border))', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 10, boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 13, color: '#0D1B1E', margin: 0 }}>Dr. Aisha Rahman</p>
            <BadgeCheck style={{ width: 14, height: 14, color: '#0A9E8A' }} />
          </div>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: '#8AAAB0', margin: '2px 0 0' }}>Cardiologist</p>
          <span style={{ background: '#22C55E18', color: '#16A34A', borderRadius: 99, padding: '2px 8px', fontSize: 9, fontFamily: 'DM Sans, sans-serif', fontWeight: 600, display: 'inline-block', marginTop: 4 }}>BMDC Verified</span>
        </div>
      </div>
      {[
        ...
        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: '#5A7A80', margin: 0 }}>{item.label}</p>
        </div>
      ))}
    </div>
...
export const DoctorScreen_Patients = React.memo(() => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
    <div style={{ background: '#0A9E8A', padding: '0 16px 14px', flexShrink: 0 }}>
      <StatusBar theme="light" />
      <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 15, color: 'white', margin: 0 }}>My Patients</p>
      <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.72)', margin: '4px 0 0' }}>24 appointments this week</p>
    </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 11, color: '#0D1B1E', margin: 0 }}>{p.name}</p>
                <span style={{ background: p.statusBg, color: p.statusColor, borderRadius: 99, padding: '2px 8px', fontSize: 9, fontFamily: 'DM Sans, sans-serif', fontWeight: 600 }}>{p.status}</span>
              </div>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 10, color: '#8AAAB0', margin: '2px 0 0' }}>{p.age} · {p.visit}</p>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 10, color: '#0A9E8A', margin: '2px 0 0' }}>{p.type}</p>
            </div>
          </div>
        </div>
      ))}
...
export const DoctorScreen_Prescription = React.memo(() => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
    <div style={{ background: '#0A9E8A', padding: '0 16px 14px', flexShrink: 0 }}>
      <StatusBar theme="light" />
      <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 14, color: 'white', margin: 0 }}>Write Prescription</p>
      <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.72)', margin: '4px 0 0' }}>Farida H. · Follow-up visit</p>
    </div>
    <div style={{ flex: 1, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 10 }}>
      {[
        { name: 'Atenolol 50mg' },
        ...
        <div key={i} style={{ background: 'hsl(var(--accent))', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 11, color: '#0D1B1E', flex: 1, margin: 0 }}>{m.name}</p>
      ...
      <div style={{ background: 'hsl(var(--background))', border: '1px dashed rgba(10,158,138,0.40)', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: '#8AAAB0' }}>Add medicine...</span>
      </div>
      <div style={{ background: 'hsl(var(--background))', border: '1px solid hsl(var(--border))', borderRadius: 14, padding: '10px 12px' }}>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 10, color: '#8AAAB0', margin: 0 }}>Notes: Low sodium diet. Follow-up in 30 days.</p>
      </div>
      <button style={{ width: '100%', background: '#0A9E8A', color: 'white', borderRadius: 99, padding: '10px 14px', fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 13, border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, boxShadow: '0 2px 8px rgba(10,158,138,0.35)', cursor: 'default' }}>
...
export const DoctorScreen_Analytics = React.memo(() => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
    <div style={{ background: '#0A9E8A', padding: '0 16px 14px', flexShrink: 0 }}>
      <StatusBar theme="light" />
      <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 15, color: 'white', margin: 0 }}>Practice Analytics</p>
      <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.72)', margin: '4px 0 0' }}>This month</p>
    </div>
    <div style={{ flex: 1, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 10 }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
        {[{ label: 'Profile Views', val: '847' }, { label: 'Bookings', val: '62' }, { label: 'Reviews', val: '4.9' }].map((s) => (
          <div key={s.label} style={{ background: 'hsl(var(--accent))', borderRadius: 14, padding: '8px 6px', textAlign: 'center' }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 14, color: '#0A9E8A', margin: 0, fontVariantNumeric: 'tabular-nums' }}>
              {s.val}
              {s.label === 'Reviews' && <Star style={{ width: 10, height: 10, fill: '#F59E0B', color: '#F59E0B', display: 'inline', marginLeft: 2, verticalAlign: 'middle' }} />}
            </p>
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 9, color: '#8AAAB0', margin: '4px 0 0' }}>{s.label}</p>
          </div>
        ))}
      </div>
      <div style={{ background: 'hsl(var(--background))', border: '1px solid hsl(var(--border))', borderRadius: 14, padding: '10px 12px' }}>
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontWeight: 500, fontSize: 10, color: '#8AAAB0', margin: '0 0 8px' }}>Weekly Appointments</p>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
          {['M','T','W','T','F','S','S'].map((d, i) => (
            <span key={i} style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 9, color: '#8AAAB0', flex: 1, textAlign: 'center' }}>{d}</span>
          ))}
        </div>
      </div>
      <div style={{ background: 'hsl(var(--accent))', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 10, color: '#8AAAB0', margin: 0 }}>Monthly Revenue</p>
          <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 16, color: '#0A9E8A', margin: '2px 0 0', fontVariantNumeric: 'tabular-nums' }}>BDT 49,600</p>
        </div>
  ...
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
    <div style={{ background: '#0A9E8A', padding: '0 16px 14px', flexShrink: 0 }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.18)', borderRadius: 24, padding: '7px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.65)' }}>Search doctors...</span>
      </div>
    </div>
    <div style={{ flex: 1, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 10, overflow: 'hidden' }}>
      <div>
        <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 14, color: '#0D1B1E', margin: 0 }}>Today</p>
        <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
          {[{n:12,d:'S'},{n:13,d:'M'},{n:14,d:'T',active:true},{n:15,d:'W'},{n:16,d:'T'},{n:17,d:'F'}].map((day) => (
            <div key={day.n} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', borderRadius: 99, width: 32, padding: '4px 0', background: (day as any).active ? '#0A9E8A' : 'transparent' }}>
              <span style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 12, color: (day as any).active ? 'white' : '#0D1B1E' }}>{day.n}</span>
            </div>
          ))}
        </div>
      </div>
      <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 12, color: '#0D1B1E', margin: 0 }}>Schedule Today</p>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ background: 'rgba(10,158,138,0.10)', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 11, color: '#0D1B1E', margin: 0 }}>Dr. Aisha R.</p>
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 9, color: '#8AAAB0', margin: '2px 0 0' }}>Cardiologist · 10:00 AM</p>
          </div>
          <button style={{ background: '#0A9E8A', color: 'white', borderRadius: 99, padding: '4px 12px', fontSize: 9, fontFamily: 'Sora, sans-serif', fontWeight: 600, border: 'none', cursor: 'default' }}>Join</button>
        </div>
        <div style={{ background: 'rgba(245,158,11,0.10)', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 11, color: '#0D1B1E', margin: 0 }}>Dr. Karim H.</p>
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 9, color: '#8AAAB0', margin: '2px 0 0' }}>Pediatrician · 2:30 PM</p>
          </div>
          <button style={{ background: '#F59E0B', color: 'white', borderRadius: 99, padding: '4px 12px', fontSize: 9, fontFamily: 'Sora, sans-serif', fontWeight: 600, border: 'none', cursor: 'default' }}>Join</button>
        </div>
      </div>
      <div style={{ background: 'hsl(var(--accent))', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 10, color: '#5A7A80', margin: 0 }}>Upcoming: Dr. Aisha consultation in 2 hours</p>
      </div>
    </div>
...
export const DoctorScreen_ProfileEditor = React.memo(() => (
  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
    <div style={{ background: '#0A9E8A', padding: '0 16px 14px', flexShrink: 0 }}>
      <StatusBar theme="light" />
      <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: 14, color: 'white', margin: 0 }}>Edit Profile</p>
    </div>
    <div style={{ flex: 1, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 10 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 13, color: '#0D1B1E', margin: 0 }}>Dr. Aisha Rahman</p>
          <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 10, color: '#0A9E8A', margin: '2px 0 0' }}>Edit profile photo</p>
        </div>
      </div>
      {[
        ...
        <div key={i} style={{ background: 'hsl(var(--accent))', borderRadius: 14, padding: '10px 12px', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 9, color: '#8AAAB0', margin: 0 }}>{field.label}</p>
            <p style={{ fontFamily: 'Sora, sans-serif', fontWeight: 600, fontSize: 11, color: '#0D1B1E', margin: '2px 0 0' }}>{field.value}</p>
          </div>
