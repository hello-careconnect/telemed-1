...
const { doctorJourney: t } = translations;

const ICONS = [BadgeCheck, Users, FileText, BarChart3, CalendarClock, UserCog];
const SCREENS = [
  <DoctorScreen_Listing />,
  <DoctorScreen_Patients />,
  <DoctorScreen_Prescription />,
...
export const DoctorJourney = () => {
  ...
  return (
    <section id="doctor-section" style={banglaFont} className="relative py-10 sm:py-14 lg:py-16 bg-[#0a0a1a]">
      {/* Background */}
